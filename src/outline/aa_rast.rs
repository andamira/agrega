...
pub struct RasterizerOutlineAA<'a, T: DrawOutline> {
    ren: &'a mut T,
    start_x: i64,
    start_y: i64,
...
impl<'a, T: DrawOutline> RasterizerOutlineAA<'a, T> {
    ...
    const fn cmp_dist_start(d: i64) -> bool { d > 0 }
    #[inline] #[must_use] #[rustfmt::skip]
    const fn cmp_dist_end(d: i64) -> bool { d <= 0 }
