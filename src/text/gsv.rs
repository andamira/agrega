...
use crate::{paths::Vertex, VertexSource};
use alloc::{
...
/// Renders text as vector graphics.
...
impl GsvText {
    /// Creates a new `GsvText`, using [`GsvDefaultFont`].
    pub fn new() -> Self {
        Self {
            x: 0.0,
            y: 0.0,
    ...
    /// Sets the height and width of the text.
    ...
    /// Defines where the text begins on the rendering surface.
    ...
    /// Specifies the actual string of text to render.
